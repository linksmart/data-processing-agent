...
public class MqttAsyncDispatcher implements MqttCallback
{
	...
	public void connectionLost(Throwable t)
	{
		...
		// error.
		this.logger.warn("Lost connection with the given MQTT broker...", t);
	...
	/**
	 *  Publishes the given message payload to the given topic using the given QoS level
	...
	/**
	 * Asynchronously disconnects from the given message broker when disconnected sets the
	 * connection flag at false;
	 * 
	 * The returned IMqttToken might be used to wrap the asynchronous call to a
	 * synchronous invocation.
	 * 
