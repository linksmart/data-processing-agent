...
public class StatementFeederImpl extends EventFeederImpl {

    private Gson parser = new Gson();

    @SuppressWarnings("UnusedDeclaration")
    public StatementFeederImpl(String brokerName, String brokerPort, String topic) throws MalformedURLException, MqttException {
