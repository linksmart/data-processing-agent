 ...
 * 
 * <p>to compress the data before encoding it and then making the output have no
...
public class Base64 {
	 ...
	 * Serializes an object and returns the Base64-encoded version of that
	 * serialized object. If the object cannot be serialized or there is another
	 * error, the method will return <tt>null</tt>. <p> Valid options:<pre>
	 ...
	 * encoding non-compliant.</i> </pre> <p> Example: <code>encodeObject(
	 * myObj, Base64.GZIP )</code> or <p> Example: <code>encodeObject( myObj,
	...
	/**
	 * Encodes a byte array into Base64 notation. <p> Valid options:<pre> GZIP:
	 * gzip-compresses object before encoding it. DONT_BREAK_LINES: don't break
	 * lines at 76 characters <i>Note: Technically, this makes your encoding
	 * non-compliant.</i> </pre> <p> Example: <code>encodeBytes( myData,
	 * Base64.GZIP )</code> or <p> Example: <code>encodeBytes( myData,
	 * Base64.GZIP | Base64.DONT_BREAK_LINES )</code>
	 * 
	 * 
	 * @param source
	...
	public static class InputStream extends java.io.FilterInputStream {
		 ...
		 * mode. <p> Valid options:<pre> ENCODE or DECODE: Encode or Decode as
		 * data is read. DONT_BREAK_LINES: don't break lines at 76 characters
		 * (only meaningful when encoding) <i>Note: Technically, this makes your
		 * encoding non-compliant.</i> </pre> <p> Example: <code>new
