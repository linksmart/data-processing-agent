package eu.linksmart.gc.network.backbone.protocol.mqtt.bas;
...
public class BrokerConnectionService  {
    ...
    private void registerBroker() throws RemoteException {
        ...
        if(registration != null && registration.length > 0){
            ...
            brokerRegistrationInfo = networkManager.registerService(attributes,getBrokerName(),MqttBrokerAsServiceBBPImpl.class.getName());
