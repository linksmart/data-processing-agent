...
public class TelecomBench2Light_M1 extends TelecomBaseDevice implements
        LightSensor, DataUpdateSubscriber<ContentInstances>
{
    ...
    private static final Logger log = LoggerFactory
            .getLogger(TelecomBench2Light_M1.class);

    public TelecomBench2Light_M1(String contentInstanceUrl)
    {
                        ...
                        .getContentInstanceCollection().getContentInstance())
                {
                            ...
                            .getSearchString())
                    {
                        if (searchString.equals("M1"))
                        {
                            ...
                            if (new Double(
                                    Double.parseDouble(m2json.getLight())) != null)
                                this.lumen = Double.parseDouble(m2json
                                        .getLight());
