...
public class WasteBinSimulatorManager extends PollingDevicesManager<WasteBinSensorData>
{
	 ...
	 * Empty constructor respecting the bean instantiation pattern
	 */
	public WasteBinSimulatorManager(String cityModel, String cityModelFile, String cityModelPrefix, String ontologyDir, int pollingTimeMillis)
	{
		super();
			...
			Callable<Boolean> task = new Callable<Boolean>() {
				...
				public Boolean call()
				{
					...
					addSubscription(new DataUpdateSubscription<WasteBinSensorData>(
							Math.max(requiredPollingTime,WasteBinSimulatorManager.MINIMUM_POLLING_TIME), currentBin, currentBin.getNetworkLevelId()));
...
//                          for(DataUpdateSubscription<WasteBinSensorData> subscription : this.lowLevelDataSubscriptions.get(device.getId()))
