...
public class M2MUtility extends TimerTask
{
    ...
    private void retrieveContainer(String containerUrl)
    {
        ...
        try
        {
            ...
            Container container = this.xmlMapper.unmarshal(Container.class,
                        ...
                        .getSearchString())
                {
                    ...
                    try
                    {
                        ...
                        for (M2MDeviceListener m : this.m2mDeviceListeners)
                        {
                            ...
                            this.contentInstancesUrlMap.put(deviceId,
                                    container.getContentInstancesReference());
     ...
     * 
     * @return an hash map with the container name as key and a content instance
     *         url
     */
    @JsonIgnore
