...
from topics
		...
		{/almanac/observation/iotentity/_e66264cb_f240_39f9_9678_bb7b00b34bcd}(cast(properties[0].ioTStateObservation[0].value,double) >= 30.0).std:lastevent() as thermometer 