...
public interface HandlerConst {
    public static final String EVENT_OUT_TOPIC_CONF_PATH = "api_events_mqtt_topic_outgoing";
    ...
    public static final String AGGREGATE_EVENTS_CONF = "handler_events_output_aggregation";
}
