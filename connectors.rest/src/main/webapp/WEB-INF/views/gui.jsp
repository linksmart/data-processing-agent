	...
	<div class="top">
		...
		<div id="logo">
			<span class="image avatar48"><img
				src="resources/images/pwallogo.jpg" alt="" /></span>
			<h1 id="title">PWAL</h1>
		...
		<nav id="nav"> 
		<ul>
			<li><a href="#top" id="top-link" class="skel-panels-ignoreHref"><span
					class="fa fa-home">Intro</span></a></li>
			<li><a href="#portfolio" id="portfolio-link"
				class="skel-panels-ignoreHref"><span class="fa fa-tasks">PWAL Log</span></a></li>
