...
@Controller
public class IoTWeekGui{
	
	@Autowired
	private Pwal pwal;
	
	@RequestMapping(value="iotweek", method=RequestMethod.GET)
	...
	@RequestMapping(value="iotweeksensor", method=RequestMethod.GET)
	@ResponseBody
	public String loadsensors(Model model)
	{
		...
		return "iotweek#sensors";
	}
	
	@RequestMapping(value="iotweeklog", method=RequestMethod.GET)
	@ResponseBody
