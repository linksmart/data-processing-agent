 ...
 */
/**
 * The exception represent any kind of exception where neither the source of the error cannot be traced back nor the reason.
 * This Exception rises mostly in big try catch blocks were the source cannot be traced.
