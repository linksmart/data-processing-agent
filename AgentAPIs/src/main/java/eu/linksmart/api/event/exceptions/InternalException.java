 ...
 */
/**
 * The exception represent any kind of traceable exception where the source of the error is an bad internal logic.
 * This kind of error are thrown when an unexpected but predicted error happens. In other words, errors that are logically
