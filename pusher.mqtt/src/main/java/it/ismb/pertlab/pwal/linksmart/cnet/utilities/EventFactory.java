...
import it.ismb.pertlab.pwal.linksmart.cnet.jaxb.ContentType;
import it.ismb.pertlab.pwal.linksmart.cnet.jaxb.Event;
import it.ismb.pertlab.pwal.linksmart.cnet.jaxb.EventMeta;
import it.ismb.pertlab.pwal.linksmart.cnet.jaxb.IoTEntity;
import it.ismb.pertlab.pwal.linksmart.cnet.jaxb.IoTProperty;
import it.ismb.pertlab.pwal.linksmart.cnet.jaxb.IoTStateObservation;
import it.ismb.pertlab.pwal.linksmart.cnet.jaxb.ObjectFactory;
import it.ismb.pertlab.pwal.linksmart.cnet.jaxb.Source;
import it.ismb.pertlab.pwal.linksmart.cnet.jaxb.TypedStringType;
...
public class EventFactory
{
    ...
    public Event createEvent(PWALNewDataAvailableEvent event, String eventType)
            throws DatatypeConfigurationException, JAXBException
    {
        // create CNET Event object
        Event toReturn = this.objectFactory.createEvent();
        ...
        //set the event type
        TypedStringType eventTypeTypedString = this.objectFactory.createTypedStringType();
        eventTypeTypedString.getTypeof().add(String.format("%s:%s", "almanac",event.getSender().getType()));
        ...
        if (existingIoTEntity != null)
        {
            ...
            source.setAbout(UUID.nameUUIDFromBytes(new String("ALMANAC").getBytes()).toString());
            source.setProject("ALMANAC");
            toReturn.setSource(source);

            // set the IoTEntity as Event Content Type
            ContentType ct = this.objectFactory.createContentType();
