...
public class TelecomBench2Pressure_M1 extends TelecomBaseDevice implements
        PressureSensor
{
    ...
    private static final Logger log = LoggerFactory
            .getLogger(TelecomBench2Pressure_M1.class);

    public TelecomBench2Pressure_M1(String contentInstanceUrl)
    {
