...
public class TelecomBench2Temperature_M1 extends TelecomBaseDevice implements
        Thermometer, DataUpdateSubscriber<ContentInstances>
{
    ...
    private static final Logger log = LoggerFactory
            .getLogger(TelecomBench2Temperature_M1.class);

    public TelecomBench2Temperature_M1(String contentInstanceUrl)
    {
    ...
    public void handleUpdate(ContentInstances updatedData)
    {
                        ...
                        if (searchString.equals("M1"))
                        {
                            TelecomSmartBench2M1Json m2json = PWALJsonMapper
                                    .json2obj(
                                            ...
                                            ci.getContent()
                                                    .getTextContent());
                            this.temperature = Double.parseDouble(m2json.getTemperature());
                            return;
                        }
                    }
                }
        ...
        {
            log.error("getTemperature: {}", e.getLocalizedMessage());
        }
    }
