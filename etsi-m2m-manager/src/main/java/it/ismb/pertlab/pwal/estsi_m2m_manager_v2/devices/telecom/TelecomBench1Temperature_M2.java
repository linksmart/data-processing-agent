...
public class TelecomBench1Temperature_M2 extends TelecomBaseDevice implements
        Thermometer, DataUpdateSubscriber<ContentInstances>
{
    ...
    private static final Logger log = LoggerFactory
            .getLogger(TelecomBench1Temperature_M2.class);

    public TelecomBench1Temperature_M2(String contentInstanceUrl)
    {
