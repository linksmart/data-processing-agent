...
<%!
    ...
    */
    ...
    private OMElement createEnvelope() {
       ...
       OMNamespace omNs = fac.createOMNamespace("http://axisversion.sample/xsd", OPC_PREFIX);
       OMElement method = fac.GenericFactory.createOMElement("getVersion", omNs);
       OMElement value = fac.GenericFactory.createOMElement("myValue", omNs);
