...
/**
 * Stub class used for the list of items of a Write request
 * <p> 
...
public class WriteRequestItemList extends ADBBeanImplementation {
     ...
     * 
     */
    private static final long serialVersionUID = -7206813714065085568L;
    ...
    /**
     * Returns the list of values of the items of the request as <code>ItemValue[]</code>
     * @return ItemValue[]
     */
    ...
    public static class Factory  {
         ...
         * 
         * @return the <code>WriteRequestItemList</code> parsed
         * 
