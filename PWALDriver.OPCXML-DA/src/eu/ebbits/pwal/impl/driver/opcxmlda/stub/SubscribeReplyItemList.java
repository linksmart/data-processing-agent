...
/**
 * Stub class used for the list of items of the response to a subscribe request
 * <p> 
...
public class SubscribeReplyItemList extends ADBBeanImplementation {
     ...
     * 
     */
    private static final long serialVersionUID = -4139150602105050496L;
     ...
     * This was an Array!
     */
    private SubscribeItemValue[] localItems ;
    ...
    /**
     * Returns the items' values of the response
     * 
     * @return   list of items' values of the response as <code>SubscribeItemValue[]</code>
     * 
     */
    ...
    /**
     * Sets the items' values of the response
     * 
     * @param param - list of items' values to be set as <code>SubscribeItemValue[]</code>
     */
    ...
    /**
     * Adds an item's value to the list
     * 
     * @param param - item's value to be added as <code>SubscribeItemValue</code>
     */
    public void addItems(SubscribeItemValue param) {
        ...
        //update the setting tracker
        localItemsTracker = true;
        java.util.List<SubscribeItemValue> list =
    ...
    public static class Factory  {
         ...
         * 
         * @return the <code>SubscribeReplyItemList</code> parsed
         * 
