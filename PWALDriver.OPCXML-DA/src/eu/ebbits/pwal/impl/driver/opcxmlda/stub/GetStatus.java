...
/**
 * Stub class used for GetStatus request
 * <p> 
 ...
 * @since      PWAL 0.2.0
 */
public class GetStatus extends ADBBeanImplementation {

    /**
     * 
     */
    private static final long serialVersionUID = -6795454476968511116L;
    ...
    private static final String NAME = GetStatus.class.getSimpleName();
    ...
    public static class Factory  {
         ...
         * 
         * @return the <code>GetStatus</code> parsed
         * 
        ...
        public static GetStatus parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ...
            try {
                ...
                GetStatus result = (GetStatus) checkADBBeanType(NAME,reader); 
                if(result!=null) {
                    return result;
                }
