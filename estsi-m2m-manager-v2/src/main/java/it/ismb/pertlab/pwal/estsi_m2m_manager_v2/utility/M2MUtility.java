package it.ismb.pertlab.pwal.estsi_m2m_manager_v2.utility;
...
import it.ismb.pertlab.pwal.estsi_m2m_manager_v2.utility.events.M2MDeviceListener;
...
public class M2MUtility {

	private String baseUrl;
//	private Dictionary<String, String> props; // TODO: find a better way to set
				...
				try {
					Class<?> classDevice = Class
							.forName("it.ismb.pertlab.pwal.estsi_m2m_manager_v2.devices.telecom."
									+ searchString);
					Constructor<?> constructor = classDevice.getConstructor(
							String.class);
