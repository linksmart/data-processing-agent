...
//
//  Code auto generated, and stolen
//
...
- (NSManagedObjectModel *)createManagedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"CNetModel" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)createPersistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Context.sqlite"];
