...
public class AdaptorWorker implements Runnable {
    ...
    private List<QueueEntry> outQueue = new LinkedList<QueueEntry> ();
    ...
    /** the logger. */
    private static Logger log = Logger.getLogger(AdaptorWorker.class.getName());
        ...
        while (isRunning) {
            try {
                ...
                synchronized (outQueue) {
                    ...
                    entry = ((LinkedList<QueueEntry>) outQueue).removeFirst();
