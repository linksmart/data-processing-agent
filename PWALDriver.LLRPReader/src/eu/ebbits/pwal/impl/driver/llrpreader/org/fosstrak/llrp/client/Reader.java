...
public class Reader {
     ...
     */
    public static final String LOCAL_ADAPTER_NAME = "Local";
     ...
     */
    public Reader() {
        adapterName = LOCAL_ADAPTER_NAME;
    }
    ...
    /**
     * Indicates if the reader is attached to the adapter with the name passed as parameter
     * 
     * @param aAdapterName - name of the adapter to check as <code>String</code>
     * 
     * @return    a boolean, true if the reader is attacched, false otherwise
     */
